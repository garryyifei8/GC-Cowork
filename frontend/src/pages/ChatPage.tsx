...
export const ChatPage: React.FC = () => {
  ...
  return (
    <div className="chat-page flex h-full w-full overflow-hidden">
      ...
      >
        {/* Chat header */}
        <div className="flex items-center justify-between px-6 h-14 border-b border-[#d0d4e4] shrink-0 bg-white">
          <div className="flex items-center gap-2.5">
            ...
            <div className="w-[36px] h-[36px] min-w-[36px] rounded-lg bg-gradient-to-br from-green-50 to-emerald-100 border border-emerald-500/20 shadow-sm flex items-center justify-center shrink-0 relative overflow-hidden">
              <svg viewBox="0 0 100 100" className="w-[90%] h-[90%] drop-shadow-sm">
                ...
                <path d="M50 15 C30 15, 20 45, 20 68 C20 88, 38 98, 50 98 C62 98, 80 88, 80 68 C80 45, 70 15, 50 15 Z" fill="url(#avo-body-chat)" />
            ...
            <div className="flex flex-col">
              <span className="text-[15px] font-semibold text-[#323338]">AI小助理</span>
              <span className="text-[11px] text-[#676879]">你的智能工作伙伴</span>
            </div>
          </div>
          <button
            type="button"
            ...
            disabled={isLoading}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[13px] font-medium text-[#676879]
              hover:bg-[#dcdfec] hover:text-[#323338] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            title="新对话"
          >
            <PenSquare size={14} />
            新对话
        ...
        {!isWelcome && (
          <div className="flex flex-wrap gap-2 px-6 py-2.5 border-t border-[#e6e9ef] bg-[#f6f7fb] shrink-0">
            {[
              ...
              <button
                ...
                disabled={isLoading}
                className="inline-flex items-center px-3 py-1.5 rounded-full border border-[#d0d4e4] bg-white text-[#676879] text-xs font-medium
                  hover:bg-[#cce5ff]/30 hover:border-[#0073ea]/40 hover:text-[#0073ea] transition-colors
        ...
        {/* Chat input */}
        <div className="border-t border-[#d0d4e4] bg-white shrink-0">
