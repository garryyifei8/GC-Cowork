...
def seed_documents() -> None:
    ...
    seed_data = [
        ...
        DocumentItem(
            ...
            doc_type="proposal",
            project_id="proj-004",
            content_summary="涵盖楼宇自控、安防监控、智能照明、综合布线等子系统的设计说明书",
            version="1.0",
            author="方设计",
            status="review",
        ),
        DocumentItem(
            ...
            doc_type="report",
            project_id="proj-005",
            content_summary="数据治理框架、数据仓库分层架构、数据服务API设计及数据安全管理策略",
            version="2.0",
            author="何架构",
            status="final",
        ),
        DocumentItem(
            ...
            doc_type="report",
            project_id="proj-006",
            content_summary="项目竣工验收情况汇总，含各单位工程质量评定、安全评估及整改记录",
            version="1.0",
            author="丁项目",
            status="review",
        ),
        DocumentItem(
            ...
            doc_type="proposal",
            project_id="proj-007",
            content_summary="交通枢纽项目投标文件技术标部分，含项目理解、实施方案及团队配置",
            version="0.3",
            author="廖咨询",
            status="draft",
        ),
        DocumentItem(
            ...
            doc_type="report",
            project_id="proj-008",
            content_summary="在线考试系统等保三级安全测评实施方案，含物理安全、网络安全、应用安全各项测评要点",
            version="1.0",
            author="潘安全",
            status="draft",
        ),
        DocumentItem(
            ...
            doc_type="template",
            project_id=None,
            content_summary="适用于政府信息化项目的标准合同模板，含商务条款、技术条款、验收标准及知识产权约定",
            version="2.0",
            author="李法务",
            status="final",
        ),
