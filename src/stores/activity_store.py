    ...
    _project_activities: dict[str, list[dict]] = {
        ...
        "proj-002": [
            ...
            },
            {
                ...
                "detail": {
                    "before": {"status": "active", "status_label": "开发中"},
                    "after": {"status": "risk", "status_label": "进度延误"},
                },
                "days_ago": 14,
            },
            {
            ...
            },
            {
                ...
                "detail": {
                    "task_id": "task-002-01",
                    "before": {"due_date": "2026-03-25"},
                    "after": {"due_date": "2026-04-10"},
                },
                "days_ago": 4,
            },
        ],
        ...
        "proj-008": [
            ...
            },
            {
                ...
                "detail": {
                    "before": {"status": "active", "status_label": "开发中"},
                    "after": {"status": "risk", "status_label": "资源不足"},
                },
                "days_ago": 12,
            },
            {
...
def list_task_comments(task_id: str) -> list[ActivityEvent]:
    """Return all comment-type activities for a specific task, sorted by created_at asc."""
    items = [a for a in _activities.values() if a.event_type == "task_comment" and a.detail.get("task_id") == task_id]
